...
parseArgs _ ["-h"] = Success (Help "Usage: html-search.exe query pattern [files...]")
parseArgs _ [query] = Success (Args (Q.Selector (Q.QuerySelector (Just query) [] [] [])) Stdin Nothing)
parseArgs _ _ = Error NotEnoughArgs
